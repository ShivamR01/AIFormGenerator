...
interface SectionDividerProps {
  type:
    ...
    | "ridge-up"
    | "ridge-down";
  fillClass: string; // e.g., "fill-white", "fill-black", "fill-gray-100"
}
      ...
      <div className="p-6 bg-black/30">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <code className="font-mono text-white" dangerouslySetInnerHTML={{
...
export function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white text-white">
      ...
      {/* ================= FAQ (LIGHT) ================= */}
      <motion.section
        className="mx-auto max-w-4xl px-6 py-24 bg-gray-100 text-neutral-900"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.1 }}
        variants={containerVariants}
      ...
      {/* ================= DIVIDER (LIGHT to DARK) ================= */}
      <SectionDivider type="ridge-up" fillClass="fill-gray-100" />
